  ...
  return (
    <div className="flex flex-col items-center">
      ...
      >
        ...
        <h3 className="text-2xl sm:text-3xl font-bold text-center text-pink-600 mt-2">To My Madam ji💗</h3>
      </motion.div>
          ...
          <AnimatePresence>
            ...
            >
              <div className="text-center">
                ...
                Just wanted to remind you—you're my favorite person. My days are better, smiles are wider, and life is sweeter because of you.You are the most special part of my life 💖. Every moment with you is a blessing.
                </p>
